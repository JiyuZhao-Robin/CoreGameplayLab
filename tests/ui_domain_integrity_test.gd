...
const UI_PATHS := [
	...
	"res://src/ui/view_models/factory/factory_operations_presenter.gd",
	"res://src/ui/workspaces/factory/factory_operations_overview.gd",
	"res://src/ui/workspaces/factory/factory_building_art.gd",
