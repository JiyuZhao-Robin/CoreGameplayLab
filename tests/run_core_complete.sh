...
godot --headless --path . --log-file /tmp/helios-ui-input-accessibility.log --script res://tests/scene_test_runner.gd -- --test-scene=res://tests/ui_input_accessibility_test.tscn --no-persistence
