...
const REQUIRED_CORE_ACTIONS := [
	...
	"BUILD_ROAD", "REMOVE_ROAD", "DEPLOY_BUILDING", "SET_RECIPE", "CANCEL_CONSTRUCTION", "REMOVE_ENTITY",
...
const RETIRED_ACTIONS := [
	...
	"CONNECT_ENTITIES", "REMOVE_LINK", "IMPORT_FROM_LOCATION", "EXPORT_TO_LOCATION",
	"CHANGE_PROJECT_PRIORITY", "CANCEL_MEGASTRUCTURE_PHASE",
